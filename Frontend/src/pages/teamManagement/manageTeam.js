...
function TeamManagement() {
    ...
    const updateRole = (email, role) => {
        ...
        axios
            .post('https://9m5y4kp37i.execute-api.us-east-1.amazonaws.com/t1/update-member-role', requestData)
            .then((response) => {
    ...
    const inviteMember = (email) => {
        ...
        axios
            .post('https://43oo1kgp3b.execute-api.us-east-1.amazonaws.com/t1/inviteteammember', requestData)
            .then((response) => {
                console.log(response.data);
                setInvitationSent(true);
            })
